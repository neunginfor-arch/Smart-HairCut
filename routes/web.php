...
Route::get('/payment/qr-image', [PaymentController::class, 'qrImage'])->name('payments.qr-image');
Route::get('/payment/qr-image/download', [PaymentController::class, 'downloadQrImage'])->name('payments.qr-image.download');
...
Route::get('/promotions/{promotion}/image', [PromotionController::class, 'image'])->name('promotions.image');
...
Route::get('/booking/{booking}/payment', [PaymentController::class, 'show'])->middleware('member.session')->name('payments.show');
Route::post('/booking/{booking}/payment', [PaymentController::class, 'verify'])->middleware(['member.session', 'throttle:5,1'])->name('payments.verify');
